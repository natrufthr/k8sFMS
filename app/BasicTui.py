...
#                 Input(placeholder="AirportName", id="airport_name"),
#                 Button("Submit", variant="primary", id="submit_button")
#             )
#         )
#
#     # @on(Input.Submitted, "#airport_name")
#     def on_button_pressed(self, event: Button.Pressed) -> None:
#         spoke_name = self.query_one("#spoke_name")
#         spoke_name = spoke_name.value
#         self.mount(Label(spoke_name))
#         # input.value = ""
#
# class AddAirline(ModalScreen):
#     """Screen with a dialog to quit."""
#     CSS_PATH = "button.tcss"
#
#     def compose(self) -> ComposeResult:
